...
public class DisplayVehiclesService extends MenuService {
	...
	public void traitement() {
		...
		String html = "<table cellspacing=0>"
				+ "<tr class='bg-green'><td>&nbsp;</td><td>&nbsp;</td><td>Catégorie</td><td>Type</td><td>Marque</td><td>Modèle</td><td>Plaque d'immatriculation</td><td>kilométrage</td><td>statut</td></tr>";
		for (Vehicle vehicle : vehicles) {
			html += "<tr>" + "  <td><a class='btn-blue' href='updateVehicle(" + vehicle.getId()
					+ ")'><img width=25 src='images/pencil-blue-xs.png'></a></td>"
					+ "  <td><a class='btn-red' href='deleteVehicle(" + vehicle.getId()
					+ ")'><img width=25 src='images/trash-red-xs.png'></a></td>" + "  <td width='150px'>"
					+ vehicle.getModel().getCategory() + "</td>" + "  <td width='150px'>"
					+ vehicle.getModel().getTypeVehicle().getName() + "</td>" + "  <td width='150px'>"
					+ vehicle.getModel().getMake().getName() + "</td>" + "  <td width='150px'>"
					+ vehicle.getModel().getName() + "</td>" + "  <td width='150px'>" + vehicle.getNumberPlate()
					+ "</td>" + "  <td width='150px'>" + vehicle.getMileage() + "</td>" + "  <td width='150px'>"
					+ vehicle.getStatusVehicle() + "</td>" + "</tr>";
		}
		html += "</table>";
